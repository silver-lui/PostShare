...
from .forms import ProfileForm, UpdateUsernameForm, CustomPasswordChangeForm
...
def updateUser(request):
    ...
    profile_picture_form = ProfileForm(instance=profile)
    ...
    if request.method == 'POST':
        if 'update_username' in request.POST:
            ...
            profile_picture_form = ProfileForm(request.POST, request.FILES, instance=profile)
